 ...
 * guias criados por um utilizador.
 */
public class PaginaMeusGuias extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_meus_guias);
        ...
        mListView = (ListView) findViewById(R.id.lista_meus_guias);
    ...
    private void carregarGuias() {
        ...
        StringRequest strRequest = new StringRequest(Request.Method.GET, "http://"
                ...
                + getResources().getString(R.string.rest_key) + "/guias?email=" + sp.getString("email", null), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if (listaGuiasTuristicos == null) {
                    ...
                    Log.e("SAAAAAAAAAA", "onResponse: " + "Entrou");
                    ListaGuiasListAdapter listaGuiasListAdapter = new ListaGuiasListAdapter(getApplicationContext(), R.layout.adapter_view_ver_guias, listaGuiasTuristicos, getSupportFragmentManager(), true);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.paginaPerfil: {
                if (sp.getBoolean("logado", false)) {
                    startActivity(new Intent(PaginaMeusGuias.this, PaginaPerfil.class));
                } else {
                    startActivity(new Intent(PaginaMeusGuias.this, PaginaLogin.class));
                }
                break;
            }
            case R.id.paginaCriarGuia: {
                if (sp.getBoolean("logado", false)) {
                    startActivity(new Intent(PaginaMeusGuias.this, PaginaCriarGuia.class));
                } else {
                    startActivity(new Intent(PaginaMeusGuias.this, PaginaLogin.class));
                }
                break;
            ...
            case R.id.paginaMeusGuias: {
                startActivity(new Intent(PaginaMeusGuias.this, PaginaMeusGuias.class));
                break;
            }
            case R.id.paginaAjuda: {
                startActivity(new Intent(PaginaMeusGuias.this, PaginaAjuda.class));
                break;
            }
            case R.id.paginaInicial: {
                startActivity(new Intent(PaginaMeusGuias.this, PaginaInicial.class));
                break;
            }
