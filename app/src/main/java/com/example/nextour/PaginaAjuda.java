...
/**
 * Classe utilizada para referenciar os componentes e executar as ações da página que vai indicar as
 * opções de ajuda da aplicação.
 */
public class PaginaAjuda extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_ajuda);
        ...
        termos = findViewById(R.id.botao_termos);
        termos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PaginaAjuda.this, PaginaTermos.class));
            }
        });

        politicas = findViewById(R.id.botao_politicas);
        politicas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PaginaAjuda.this, PaginaPoliticas.class));
            }
        });
        botoesDisponiveis();
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.paginaPerfil: {
                if (sp.getBoolean("logado", false)) {
                    startActivity(new Intent(PaginaAjuda.this, PaginaPerfil.class));
                } else {
                    startActivity(new Intent(PaginaAjuda.this, PaginaLogin.class));
                }
                break;
            }
            case R.id.paginaCriarGuia: {
                if (sp.getBoolean("logado", false)) {
                    startActivity(new Intent(PaginaAjuda.this, PaginaCriarGuia.class));
                } else {
                    startActivity(new Intent(PaginaAjuda.this, PaginaLogin.class));
                }
                break;
            ...
            case R.id.paginaMeusGuias: {
                startActivity(new Intent(PaginaAjuda.this, PaginaMeusGuias.class));
                break;
            }
            case R.id.paginaAjuda: {
                startActivity(new Intent(PaginaAjuda.this, PaginaAjuda.class));
                break;
            }
            case R.id.paginaInicial: {
                startActivity(new Intent(PaginaAjuda.this, PaginaInicial.class));
                break;
            }
