...
/**
 * Classe utilizada para referenciar os componentes e executar as ações da página que vai mostar os
 * guias favoritos de um utilizador.
 */
public class PaginaFavoritos extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setSelectedItemId(R.id.paginaFavoritos);
    ...
    private void carregarGuias() {
        ...
        StringRequest strRequest = new StringRequest(Request.Method.GET, "http://"
                ...
                + getResources().getString(R.string.rest_key) + "/guias/favoritos?email="
                + sp.getString("email", ""), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if (listaGuiasTuristicos == null) {
                    Toast.makeText(getApplicationContext(), "Ainda não tens guias favoritos", Toast.LENGTH_LONG).show();
                } else {
